...
| Whole `layout-gate` family (44 files) | **1,362** (1,299 pre-merge) | > 3,900 | 2m06s (**2m12s** wall) | — |
| Whole PR gate (`./run_tests.sh`) | **5,310** (5,223 pre-merge) | — | 2m53s (**2m59s** wall) | — |
