...
A baseline is 14,847 sorted rows across five files. `check` answers "did it move";
...
identical. What is being frozen is the *coverage*: **14,847**
...
late 234 for `pnp_setup`, #1379's 1,404, #1380's 4,914 and #1489's 468 + 702, **less the one** the
