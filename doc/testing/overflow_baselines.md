...
A baseline is 13,678 sorted rows across five files. `check` answers "did it move";
...
identical. What is being frozen is the *coverage*: **13,678**
...
late 234 for `pnp_setup`, #1379's 1,404 and #1380's 4,914). Against an all-clean baseline the
