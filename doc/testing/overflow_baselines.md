...
A baseline is 15,315 sorted rows across five files. `check` answers "did it move";
...
identical. What is being frozen is the *coverage*: **15,315**
...
`firmware_ota` and #1554's 234 for `pnp_setup_firmware`, **less the one** the
