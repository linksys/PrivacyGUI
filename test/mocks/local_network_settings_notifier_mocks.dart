...
class MockLocalNetworkSettingsNotifier
  ...
  @override
  _i5.Future<void> saveReservations(List<_i6.DHCPReservationUIModel>? list) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveReservations,
          [list],
  ...
  void updateDHCPReservationList(
          List<_i6.DHCPReservationUIModel>? addedDHCPReservationList) =>
      super.noSuchMethod(
        Invocation.method(
  ...
  bool updateDHCPReservationOfIndex(
    _i6.DHCPReservationUIModel? item,
    int? index,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  bool isReservationOverlap({
    required _i6.DHCPReservationUIModel? item,
    int? index,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
