...
class MockPortRangeTriggeringRuleNotifier
  ...
  @override
  void init(
    List<_i4.PortRangeTriggeringRuleUIModel>? rules,
    _i4.PortRangeTriggeringRuleUIModel? rule,
    int? index,
  ) =>
      super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void updateRule(_i4.PortRangeTriggeringRuleUIModel? rule) =>
      super.noSuchMethod(
        Invocation.method(
          #updateRule,
          [rule],
  ...
  @override
  bool isTriggeredPortConflict(
    int? firstPort,
    int? lastPort,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #isTriggeredPortConflict,
          [
            firstPort,
            lastPort,
          ],
  ...
  @override
  bool isForwardedPortConflict(
    int? firstPort,
    int? lastPort,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #isForwardedPortConflict,
          [
            firstPort,
            lastPort,
          ],
