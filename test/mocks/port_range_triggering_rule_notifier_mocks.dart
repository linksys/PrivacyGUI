...
// in privacy_gui/test/mocks/mockito_specs/port_range_triggering_rule_notifier_spec.dart.
...
class MockPortRangeTriggeringRuleNotifier
  ...
  @override
  void init(
    List<_i4.PortRangeTriggeringRule>? rules,
    _i4.PortRangeTriggeringRule? rule,
    int? index,
  ) =>
      super.noSuchMethod(
        Invocation.method(#init, [rules, rule, index]),
        returnValueForMissingStub: null,
      );

  @override
  void updateRule(_i4.PortRangeTriggeringRule? rule) => super.noSuchMethod(
  ...
  bool isTriggeredPortConflict(int? firstPort, int? lastPort) =>
      (super.noSuchMethod(
        Invocation.method(#isTriggeredPortConflict, [firstPort, lastPort]),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);
  ...
  bool isForwardedPortConflict(int? firstPort, int? lastPort) =>
      (super.noSuchMethod(
        Invocation.method(#isForwardedPortConflict, [firstPort, lastPort]),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);
