...
void main() {
  group('test auth challenge in dev', () {
    test('account preparation', () async {
      String appId = 'ee7652e0-9a25-4ee5-9974-944179415be0';
      String appSecret = 'laxhR+c4Z61RU0yQhM22zro0Ej4XqKSjjQFY9nOQaWH/TnS91JIaVy7Ckq1eNSH1uHjFE0HthsLF7Bdt4tpTUXbteU4N7M9/RG1LIQ9AD8wAsp2zKR8KZE5RDRiwd6s2pgcL4SPCcEj8W4lecG1ynqS10R5sW8RiPZFjfmLtBSY=';
      String token = '98DBD3BE-2114-43A3-B539-D0857D5B8493';

      final client = DevTestableClient();
      AuthChallengeMethod method = AuthChallengeMethod(token: token, method: "EMAIL", target: "austin.chang@linksys.com");
      final response = await client.authChallenge(method, id: appId, secret: appSecret);
    });
  });
}