...
### Requirement: Timezone State Management
The system SHALL manage the Timezone settings using the standardized dirty-guard framework, ensuring automatic detection of unsaved changes and consistent handling of navigation.

#### Scenario: Modify Timezone settings and save
- **GIVEN** the user is on the Timezone page.
- **WHEN** the user modifies a setting (e.g., changes the timezone).
...
- **GIVEN** the user has modified a setting on the Timezone page, making it "dirty".
