...
### Requirement: Instant Privacy State Management
The system SHALL manage the Instant Privacy settings using the standardized dirty-guard framework, ensuring automatic detection of unsaved changes and consistent handling of navigation.

#### Scenario: Modify Instant Privacy settings and save
- **GIVEN** the user is on the Instant Privacy page.
- **WHEN** the user modifies a setting (e.g., enables MAC filtering).
...
- **GIVEN** the user has modified a setting on the Instant Privacy page, making it "dirty".
