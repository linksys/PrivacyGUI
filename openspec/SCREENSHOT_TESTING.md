...
4.  **Manual Adjustments (Important!)**
    ...
    *   **Move and Rename**: Move the newly generated `test/mocks/mockito_specs/your_notifier_spec.mocks.dart` file to the `test/mocks/` directory and rename it to `your_notifier_mocks.dart`. 
    **This step is mandatory; otherwise, the file will be ignored by version control.** 
    **IF THE FILE IS EXISTING, DELETE IT BEFORE MOVING.**
