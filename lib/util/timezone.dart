...
String getTimeZoneRegionName(BuildContext context, timezoneId) {
  switch (timezoneId) {
    ...
    case 'CST6':
      return getAppLocalizations(context).timezoneCentralTimeUSAnCanada;
    case 'PST8':
      return getAppLocalizations(context).timezonePacificTimeUSAnCanada;
    case 'JST-9-NO-DST':
      return getAppLocalizations(context).timezoneJapanKorea;
    case 'EST5':
      return getAppLocalizations(context).timezoneEasternTimeUSAnCanada;
    case 'ICT-7-NO-DST':
    ...
    case 'MST7':
      return getAppLocalizations(context).timezoneMountainTimeUSAnCanada;
    case 'CLT4':
