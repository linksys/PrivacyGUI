    ...
    final children = [
      columnCount > state.mainWiFi.length
          ? TableRow(children: [
              ...state.mainWiFi
                  .mapIndexed((index, e) =>
                      _mainWiFiCard(e, canBeDisabled, lastInRow: index == columnCount - 1))
                  .toList(),
              _guestWiFiCard(state.guestWiFi, lastInRow: true),
            ])
          : columnCount == state.mainWiFi.length
              ? TableRow(children: [
                  ...state.mainWiFi
      ...
      if (columnCount <= state.mainWiFi.length)
        columnCount == state.mainWiFi.length
            ? TableRow(children: [
                _guestWiFiCard(state.guestWiFi, lastInRow: false),
