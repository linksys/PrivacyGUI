/// Static lookup tables that map recommendation keys to English display
/// strings. Both the in-app card and the export service consume this catalog.
///
/// When localization lands these maps will be replaced by ARB lookups; the
/// keys are intentionally formatted as ARB-style identifiers.
class RecommendationCatalog {
  const RecommendationCatalog._();
