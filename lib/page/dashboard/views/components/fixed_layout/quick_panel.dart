...
class FixedDashboardQuickPanel extends ConsumerStatefulWidget {
  const FixedDashboardQuickPanel({
    super.key,
  ...
  @override
  ConsumerState<FixedDashboardQuickPanel> createState() =>
      _FixedDashboardQuickPanelState();
}

class _FixedDashboardQuickPanelState
    extends ConsumerState<FixedDashboardQuickPanel> {
  @override
