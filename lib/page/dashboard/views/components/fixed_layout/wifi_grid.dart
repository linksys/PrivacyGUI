...
import 'package:privacy_gui/page/dashboard/views/components/fixed_layout/wifi_card.dart';
...
class FixedDashboardWiFiGrid extends ConsumerStatefulWidget {
  const FixedDashboardWiFiGrid({
    super.key,
  ...
  @override
  ConsumerState<FixedDashboardWiFiGrid> createState() =>
      _FixedDashboardWiFiGridState();
}

class _FixedDashboardWiFiGridState
    extends ConsumerState<FixedDashboardWiFiGrid> {
