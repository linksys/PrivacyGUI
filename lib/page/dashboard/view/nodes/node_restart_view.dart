...
class NodeRestartView extends StatefulWidget {
  const NodeRestartView({Key? key}): super(key: key);

  @override
  State<StatefulWidget> createState() => _NodeRestartViewState();
}

class _NodeRestartViewState extends State<NodeRestartView> {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        SecondaryButton(
          ...
          onPress: () => NavigationCubit.of(context).pop(),
        ),
      ],
    );
  }
