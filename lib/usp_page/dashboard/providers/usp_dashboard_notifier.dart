...
class UspDashboardNotifier extends AsyncNotifier<UspDashboardState> {
  ...
  Future<String> _fetchDefaultGateway(UspService usp) async {
    try {
      ...
      logger.e('[USP] Failed to fetch default gateway: $e');
      return '';
    }
  }
  ...
  Future<
    ...
    try {
      ...
      logger.e('[USP] IPv6 fetch failed (router may not support IPv6): $e');
      return (
        lanEnabled: false,
        lanAddresses: <String>[],
        wanEnabled: false,
  ...
  Future<({FirmwareImages images, String activeRef, String bootRef})>
    ...
    try {
      ...
      logger.e('[USP] Firmware images fetch failed: $e');
      return (
  ...
  Future<Map<String, String>> _fetchBridgePortMap(UspService usp) async {
    try {
      ...
      logger.e('[USP] Bridge port map fetch failed: $e');
      return {};
    }
  }
