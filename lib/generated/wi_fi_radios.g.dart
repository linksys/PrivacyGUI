...
class WiFiRadios {
  ...
  factory WiFiRadios._fromResponse(Map<String, dynamic> response) {
    ...
    for (final id in sorted) {
      final p = '$basePath$id.';
      if ([response['${p}Enable'], response['${p}Status'], response['${p}Channel'], response['${p}OperatingFrequencyBand'], response['${p}OperatingChannelBandwidth'], response['${p}PossibleChannels'], response['${p}OperatingStandards'], response['${p}SupportedStandards'], response['${p}TransmitPower'], response['${p}MaxBitRate'], response['${p}AutoChannelEnable'], response['${p}IEEE80211hEnabled'], response['${p}SupportedOperatingChannelBandwidths']].every((v) => v == null || v == '' || v == '0' || v == 0 || v == false || v == 'false')) continue;
      items.add(WiFiRadio(
        instancePath: p,
        ...
        supportedOperatingChannelBandwidths: (response['${p}SupportedOperatingChannelBandwidths'] ?? '') as String,
      ));
    }
  ...
  static Future<Map<String, dynamic>> update(UspService client, WiFiRadioUpdate update) async {
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<WiFiRadioUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
