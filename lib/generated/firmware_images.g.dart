...
class FirmwareImages {
  ...
  factory FirmwareImages._fromResponse(Map<String, dynamic> response) {
    ...
    for (final id in sorted) {
      final p = '$basePath$id.';
      if ([response['${p}Name'], response['${p}Version'], response['${p}Status'], response['${p}Available']].every((v) => v == null || v == '' || v == '0' || v == 0 || v == false || v == 'false')) continue;
      items.add(FirmwareImage(
        ...
        available: response['${p}Available'] == true || response['${p}Available'] == 'true' || response['${p}Available'] == '1',
      ));
    }
