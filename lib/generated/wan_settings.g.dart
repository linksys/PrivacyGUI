...
class WanSettings {
  ...
  factory WanSettings._fromResponse(Map<String, dynamic> response) {
    return WanSettings(
      ...
      mtu: int.tryParse(response['Device.IP.Interface.2.MaxMTUSize'] as String? ?? '') ?? 0,
      ...
      idleDisconnectTime: int.tryParse(response['Device.PPP.Interface.1.IdleDisconnectTime'] as String? ?? '') ?? 0,
      lcpEchoInterval: int.tryParse(response['Device.PPP.Interface.1.LCPEcho'] as String? ?? '') ?? 0,
      pppConnectionStatus: response['Device.PPP.Interface.1.ConnectionStatus'] as String? ?? '',
      vlanEnabled: response['Device.Ethernet.VLANTermination.1.Enable'] == true,
      vlanId: int.tryParse(response['Device.Ethernet.VLANTermination.1.VLANID'] as String? ?? '') ?? 0,
