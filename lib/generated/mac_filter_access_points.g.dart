...
class MacFilterAccessPoints {
  ...
  factory MacFilterAccessPoints._fromResponse(Map<String, dynamic> response) {
    ...
    for (final id in sorted) {
      final p = '$basePath$id.';
      if ([response['${p}SSIDReference'], response['${p}MACAddressControlEnabled'], response['${p}AllowedMACAddress']].every((v) => v == null || v == '' || v == '0' || v == 0 || v == false || v == 'false')) continue;
  ...
  static Future<Map<String, dynamic>> update(UspService client, MacFilterAccessPointUpdate update) async {
    ...
    if (update.allowedMACAddress != null) params['${update.instancePath}AllowedMACAddress'] = update.allowedMACAddress;
    if (params.isEmpty) {
      return {
        'overallSuccess': true,
        'hasAnySuccess': false,
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<MacFilterAccessPointUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
