...
class MacFilterAccessPoints {
  ...
  static Future<void> update(UspService client, MacFilterAccessPointUpdate update) async {
  ...
  static Future<void> updateMany(UspService client, List<MacFilterAccessPointUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
