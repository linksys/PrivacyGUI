...
class VlanTermination {
  ...
  static Future<VlanTermination> fetch(UspService client) async {
  ...
  factory VlanTermination._fromResponse(Map<String, dynamic> response) {
    ...
    for (final id in sorted) {
      final p = '$basePath$id.';
      if ([response['${p}Enable'], response['${p}VLANID']].every((v) => v == null || v == '' || v == '0' || v == 0 || v == false || v == 'false')) continue;
  ...
  static Future<Map<String, dynamic>> update(UspService client, VlanTerminationInstanceUpdate update) async {
    final params = <String, dynamic>{};
    if (update.enable != null) params['${update.instancePath}Enable'] = update.enable;
    if (update.vlanId != null) params['${update.instancePath}VLANID'] = update.vlanId;
    if (params.isEmpty) {
      return {
        'overallSuccess': true,
        'hasAnySuccess': false,
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<VlanTerminationInstanceUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
