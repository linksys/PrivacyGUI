...
class DhcpReservations {
  ...
  static Future<Map<String, dynamic>> update(UspService client, DhcpReservationUpdate update) async {
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<DhcpReservationUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
