...
class AdminUsers {
  ...
  static Future<Map<String, dynamic>> update(UspService client, AdminUserUpdate update) async {
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<AdminUserUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
