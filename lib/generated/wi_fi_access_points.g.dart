...
class WiFiAccessPoints {
  ...
  factory WiFiAccessPoints._fromResponse(Map<String, dynamic> response) {
    ...
    for (final id in sorted) {
      final p = '$basePath$id.';
      if ([response['${p}Enable'], response['${p}Status'], response['${p}Security.ModesSupported'], response['${p}Security.ModeEnabled'], response['${p}Security.EncryptionMode'], response['${p}Security.KeyPassphrase'], response['${p}SSIDAdvertisementEnabled'], response['${p}SSIDReference']].every((v) => v == null || v == '' || v == '0' || v == 0 || v == false || v == 'false')) continue;
  ...
  static Future<Map<String, dynamic>> update(UspService client, WiFiAccessPointUpdate update) async {
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<WiFiAccessPointUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
