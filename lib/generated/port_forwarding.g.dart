...
class PortForwarding {
  ...
  static Future<Map<String, dynamic>> update(UspService client, PortForwardingRuleUpdate update) async {
  ...
  static Future<Map<String, dynamic>> updateMany(UspService client, List<PortForwardingRuleUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
