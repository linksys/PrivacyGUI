...
class StaticRouting {
  ...
  static Future<void> update(UspService client, StaticRouteUpdate update) async {
  ...
  static Future<void> updateMany(UspService client, List<StaticRouteUpdate> updates, {bool allowPartial = false}) async {
    final params = <String, dynamic>{};
