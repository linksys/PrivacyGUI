...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3061: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3063: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2386: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2386_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2386_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2385: (a: number, b: number) => void;
