...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3020: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3022: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2344: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2344_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2344_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2343: (a: number, b: number) => void;
