...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3014: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3016: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2342: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2342_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2342_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2341: (a: number, b: number) => void;
