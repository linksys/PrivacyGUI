...
test per coordinate, so 786 of those tests declare 15,549 cells (card 102, popup 80,
chrome 57, forced-form 37, page 510) and the other **18** are readability guards — #1349's
...
gate still measure the same 15,549 coordinates", and a refactor that stops
