...
test per coordinate, so 776 of those tests declare 15,315 cells (card 102, popup 80,
chrome 57, forced-form 37, page 500) and the other **18** are readability guards — #1349's
...
gate still measure the same 15,315 coordinates", and a refactor that stops
