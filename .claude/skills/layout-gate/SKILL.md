...
test per coordinate, so 756 of those tests declare 14,847 cells (card 102, popup 80,
chrome 57, forced-form 37, page 480) and the other **18** are readability guards — #1349's
...
pages already swept, +50 tests and +1,170 cells, so `page` reads 480 tests over 11,232 cells
...
gate still measure the same 14,847 coordinates", and a refactor that stops
